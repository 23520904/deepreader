    ...
    <section className="bg-[#eef0f7] py-[88px] max-[700px]:py-14">
      <div className="mx-auto grid w-[min(1060px,calc(100%_-_48px))] grid-cols-3 gap-0 max-[800px]:grid-cols-1 max-[700px]:w-[min(100%_-_28px,1060px)]">
        {quickLinks.map((item, index) => (
          ...
          >
            <h3 className="max-w-[250px] text-[20px] font-extrabold leading-[1.15] tracking-[-0.03em] text-[#1c2029]">
              {item.title}
            </h3>

            <Link
              href={item.href}
              className="mt-4 inline-flex text-[12px] font-semibold text-[#626b78] transition hover:text-[#245c93]"
            >
              {item.label}
            </Link>
          </article>
